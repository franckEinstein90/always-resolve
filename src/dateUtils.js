...
const dateUtils = (function() {
    ...
    let _today = new Date()
    let _pad0 = (digit) => digit.toString().padStart(2, '0')    //pads with 0 up to 2 chars
    let _separatorFIFO = ["_"]                                  //used as separator for time stamps
    ...
    return {
        ...
        popSeparator: function() {
            if (separatorFIFO.length > 0) {
                separatorFIFO.shift();
            }
        },

        firstDayOfMonth: (theYear, monthIdx) => new timeSpan.Day(new Date(theYear, monthIdx, 1)),
